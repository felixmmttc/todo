...
class ScrapNationalRegistrationDetailsCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $from = $this->argument('min');
        $to = $this->argument('max');

        if ($from > $to) {
            $this->error("Provide the right order of parameters ");
            return;
        }
            ...
            if ($response->successful()) {
                ...
                if ($matches[0] !== null) {
                    ...
                    if ($identityId[0] === null || $identityId[0] === 'null') {
                        $this->line("This ID does not exist.");
                        continue;
                    }
                    ...
                    $this->line("Scrapped data for ".$details->identityId);
                }
            }
        }
